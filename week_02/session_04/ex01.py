...
single_quotes = 'Сайн'
double_quotes = "Байна"
triple_quotes = """Энэ бол олон мөрт тэмдэгт мөр"""
...
repeated = "Python " * 3 # Давтах: "Python Python Python "
print(repeated)
...
#AND logic - 2 utga 2-uulaa unen ued unen baina
...
# Хязгаарыг давталтад ашиглах
for i in range(3):
    print(i) # 0, 1, 2 тус тусад нь 
